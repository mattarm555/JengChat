...
namespace
{
        ...
        const std::string& username)
    {
        ...
        DrawText(
            "The local prototype fills open slots with bots. Network players will replace them later.",
            65,
            641,
            15,
        ...
        const MatchResult& result)
    {
        ...
        DrawText(
            "WASD Move   RMB Camera   LMB Fire   HOLD TAB Scoreboard   R Rematch   M Setup   F11 Fullscreen   ESC Quit",
            30,
            SCREEN_HEIGHT - 48,
            17,
            RAYWHITE
...
int main(int argc, char** argv)
{
    ...
    // Use the exact same Windows executable/taskbar icon as JENG CHAT.
    SetJengTaskbarIcon(GetWindowHandle());
    ...
    const float cameraReturnSpeed = 6.0f;
    const float cameraSensitivity = 0.0080f;
    ...
    while (!WindowShouldClose())
    {
        ...
        // F11 matches the main JENG CHAT fullscreen control.
        ...
        if (inSetup)
        {
            ...
            DrawArenaRenderTarget(arenaTarget);
            EndDrawing();
        ...
        // ====================================================
        // THIRD-PERSON CAMERA
        // Always follows the local tank, even after match end.
        // ====================================================
        ...
        // Hold-to-view scoreboard: it appears only while TAB is down.
